...
, requests, packaging, pip, urllib3, pydantic, requests-mock, numpy, pillow
, dataclasses-json }:
...
buildPythonPackage rec {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-X7qUXdLvI2U0nNcWvB2cmZcnVAzOQc2UiX1mANUZSe4=";
  };
  ...
  dependencies =
    [ requests packaging pip setuptools urllib3 pydantic requests-mock ];

  optional-dependencies = { tests = [ numpy pillow dataclasses-json ]; };
